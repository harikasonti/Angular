...
export class BusinesshouseserviceService {
  ...
  sortBusinesshouse():Observable<Businesshouse[]>{
    return this.httpClient.get<Businesshouse[]>(`${this.baseURL}/avgRating`);
  }
  
  searchBusinesshouse(businessLocation:string):Observable<Businesshouse>{
    return this.httpClient.get<Businesshouse>(`${this.baseURL}/location/${businessLocation}`);
  }
